  ...
  return (
    <div className="flex flex-col w-[400px] bg-white text-gray-500 shadow-lg">
                ...
                <div className="divide-y divide-gray-100 divide-gray-200">
                  <Link
                    to="#"
                    className="flex px-4 py-3 hover:bg-gray-100 hover:bg-gray-200"
                  >
                    ...
                    <div className="w-full ps-3">
                      <div className="text-gray-500 text-sm mb-1.5 text-gray-400">
                        New message from{" "}
                      ...
                      <div className="text-xs text-blue-600 text-blue-500">
                        a few moments ago
                      </div>
                    </div>
                  </Link>
                  ...
                  >
                    <div className="flex-shrink-0">
                      <img
                        ...
                        alt="Leslie image"
                      />
                      <div className="absolute flex items-center justify-center w-5 h-5 ms-6 -mt-5 bg-green-400 border border-white rounded-full border-gray-800">
                        <svg
                          className="w-2 h-2 text-white"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="w-full ps-3">
                      <div className="text-gray-500 text-sm mb-1.5 text-gray-400">
                        ...
                        <span className="font-medium text-blue-500" to="#">
                          @bonnie.green
                        </span>{" "}
                        what do you say?
                      </div>
                  ...
                  >
                    <div className="flex-shrink-0">
                      <img
                        ...
                        alt="Robert image"
                      />
                      <div className="absolute flex items-center justify-center w-5 h-5 ms-6 -mt-5 bg-purple-500 border border-white rounded-full border-gray-800">
                        <svg
                          className="w-2 h-2 text-white"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
